...
if __name__ == "__main__":
    ...
    parser.add_argument('--standard_arg', type=int, default=42)

    # separate the known & unknown parts
    args, unknown = parser.parse_known_args()
    kwargs = collect_kwargs(unknown)

    print('Standard args:', args)
    print('Kwargs       :', kwargs)